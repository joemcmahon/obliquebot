...
module.exports = (server, db) => {
  ...
  server.get('/', (req, res) => {
    ...
    <body style='display: flex; align-items: center; justify-content: center; flex-direction: column;font-family: sans-serif'>
      <img src="https://firebasestorage.googleapis.com/v0/b/spud-reloaded.appspot.com/o/static%2Fradiospiral.png?alt=media&token=db323dc7-d68e-4cf0-a55b-1d3c338f8819"><h1><a href='https://github.com/joemcmahon/obliquebot'>obliquebot</h1>
      ...
      slack.auth.test({ token: oauthAccess.access_token }, (err, authTest) => {
        ...
        db.saveTeam(authTest.team_id, oauthAccess, (err) => {
          ...
          res.send(`
            <html>
            <body style='display: flex; align-items: center; justify-content: center; flex-direction: column;font-family: sans-serif'>
              <img src="https://firebasestorage.googleapis.com/v0/b/spud-reloaded.appspot.com/o/static%2Fradiospiral.png?alt=media&token=db323dc7-d68e-4cf0-a55b-1d3c338f8819"><h1><a href='https://github.com/joemcmahon/obliquebot'>obliquebot</a></h1>
